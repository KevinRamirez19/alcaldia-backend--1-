            ...
            <div className="grid lg:grid-cols-3 gap-8">
              {noticiasDestacadas.map((noticia) => (
                <Card key={noticia.id} className="hover:shadow-lg transition-shadow">
                  <div className="h-48 bg-gradient-to-r from-blue-400 to-green-500 rounded-t-lg"></div>
                ...
                <Card key={noticia.id} className="hover:shadow-lg transition-shadow">
                  <div className="md:flex">
                    <div className="md:w-1/4">
                      <div className="h-48 md:h-full bg-gradient-to-r from-blue-400 to-green-500 rounded-l-lg"></div>
                    </div>
